...
class Update extends Component {
  ...
  validate = (e) => {
    ...
    if (
      ...
      e.target.name === "maritalStatus" ||
      e.target.name === "accType" ||
      e.target.name === "branchName" ||
      e.target.name === "proofType" ||
      e.target.name === "holderName" ||
      e.target.name === "holderAccountNumber"
    ) {
      if (e.target.value === "") {
        this.setState({
          errors: {
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    details: state.users.LoginReducer,
  };
};
